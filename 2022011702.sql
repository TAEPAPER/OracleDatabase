2022-01-17-02) **ROLLUP과  CUBE**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
     -GROUP BY 절에서 사용되어 다양한 집계를 제공
     1)ROLLUP
       .그룹내의 집계를 사용된 컬럼들을 레벨별로 구분하여 레벨별 집계와 전체 집계를 반환
       .--**반드시 GROUP BY절에서만 사용해야 함**--
       (사용형식)
       GROUP BY ROLLUP(컬럼명1[,컬럼명2,...컬럼명n])[,컬럼명,...]
       -ROLLUP()안에 기술된 컬럼명N 부터 컬럼명1까지 레벨을 부여하여 각 레벨별 집계와 전체집계반환
       -ROLLUP()안에 기술된 컬럼의 수가 N개이면 전체 집계의 종류는 N+1개임
       -컬럼명1[,컬럼명2,...컬럼명n 모두를 기준으로 집계를 반환한 뒤 컬럼명1[,컬럼명2을 기준으로 집계 반환
        컬럼명1을 기준으로 집계 반환,전체집계반환
    ...
    2)CUBE  
      .그룹내의 집계를 사용된 컬럼들의 조합 가능한 **경우의 가지수 만큼 집계 반환**
